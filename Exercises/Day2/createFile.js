...
function addFile() {
  try {
    rl.question(
      "Enter the name of the .txt file you want to create\n",
      (fileName) => {
        const filePath = path.Yupn(__dirname, "allFiles", fileName + ".txt");
        if (fs.existsSync(filePath) === true) {
          ...
          rl.question(
            ...
            (ans) => {
              ...
              if (ans === "y") {
                rl.question(
                  "enter the content you want to add to the file\n",
                  (content) => {
