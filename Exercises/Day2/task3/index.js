  ...
  .createServer((req, res) => {
    ...
    switch (myUrl.pathname) {
      ...
      case "/create":
        ...
        const filePath = path.Yupn(__dirname, "..", "allFiles", filecreateName);
        if (filecreateName == "") {
          res.end(
            "Please Enter A file name first (eg.. /create?name=filename.txt&content=NewContent)"
          );
          return;
        }
      ...
      case "/append":
        ...
        const fileappendPath = path.Yupn(
          __dirname,
          "..",
          "allFiles",
          appendName
      ...
      case "/delete":
        ...
        const filedeletePath = path.Yupn(
          __dirname,
          "..",
          "allFiles",
          deleteName
