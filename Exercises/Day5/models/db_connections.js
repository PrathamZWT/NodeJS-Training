...
import { createrUserTable } from "./user.model.js";
import { createrUserProfilesTable } from "./userProfile.model.js";
import { createrUserImages } from "./user.images.model.js";

dotenv.config();

export let connection = mysql
  .createPool({
